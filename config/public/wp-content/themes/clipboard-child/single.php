				...
				<?php if ( $related ): ?>
					...
					<?php if( $related->have_posts() ): ?>
						...
						<div class="similarWrap">
							...
							<!-- <?php print_r($posttag); ?> -->
								<?php if($one_tag==0): ?>
									<h4>Other <a href="<?php echo get_tag_link($posttag->term_id); ?>"><?php echo $posttag->name; ?></a> Emails</h4>
			...
			<?php if( has_category() ): ?> 
				...
				<?php foreach( $cats as $cat): ?>
					...
					<div class="similarWrap">
						...
						<?php $query_args = 'p=-'.$the_big_id.'&cat='.$cat->term_id.'&posts_per_page=9'; ?>
						<?php $query_args = array(
							'post__not_in' => array($the_big_id),
							'cat' => $cat->term_id,
							'posts_per_page' => 9
						); ?>
						<!-- <?php echo $query_args; ?> -->
						<?php $the_cat_query = new WP_Query( $query_args ); ?>
						<?php if ( $the_cat_query->have_posts() ): ?>
							<h4>Other Emails from <a href="<?php echo get_category_link( $cat->term_id );?>"><?php echo $cat->name; ?></a></h4>
